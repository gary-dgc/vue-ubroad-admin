  ...
  <div class="forget-pwd">
    ...
    >
      <a-form :label-col="labelCol" :wrapper-col="wrapperCol">
        ...
        <a-form-item label="确认新密码" v-bind="validateInfos.confirmPassword">
          <a-input-password
...
<script>
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const message = ref('密码必须至少包含一个数字、一个字母和一个符号，并且长度在6-12位');
      ...
      const { resetFields, validate, validateInfos } = useForm(formObject, getRules);
