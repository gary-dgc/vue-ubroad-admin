import { isString, isObject, isArray } from './common';
...
export const getLocCache = (key) => {
  ...
  if (isString(cacheValue)) {
    if (cacheValue.indexOf('{') === 0 && cacheValue.lastIndexOf('}') === cacheValue.length - 1) {
      ...
      return cacheValue;
    } else if (cacheValue.indexOf('[') === 0 && cacheValue.lastIndexOf(']') === cacheValue.length - 1) {
